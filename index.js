  ...
  try {
    ...
    if (interaction.isModalSubmit()) {
      ...
      if (interaction.customId === "broadcast_modal") {
        await interaction.deferUpdate(); // Prevent "cranking"
        ...
        // Edit the correct message reference from the session
    ...
    if (interaction.isButton()) {
      ...
      if (data) {
        ...
        if (interaction.customId === "back") {
          ...
          // Update message reference so the next modal submission knows where to edit
      ...
      if (interaction.customId.startsWith("approve_")) {
        ...
        await member.send(`✅ Approved! Welcome to **Inter Molds, Inc.** 🎉`).catch(() => {});
